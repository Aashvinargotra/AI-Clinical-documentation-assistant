...
def generate_soap_note(transcript: str) -> SOAPNote:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are an expert clinical documentation assistant. Given a raw transcript of a doctor-patient consultation, generate a formal SOAP note following strict clinical guidelines."),
        ("user", "Transcript:\n{transcript}\n\nGenerate the structured SOAP note.")
    ])
